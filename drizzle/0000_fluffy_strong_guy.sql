CREATE TYPE "public"."plan_status" AS ENUM('trialing', 'active', 'past_due', 'read_only', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('owner', 'staff', 'viewer');--> statement-breakpoint
...
CREATE TABLE "tenants" (
	...
	"delivery_fee_default" numeric(12, 2),
	"public_page_paused" boolean DEFAULT false NOT NULL,
